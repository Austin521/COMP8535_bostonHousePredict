...
# Apply UMAP for dimensionality reduction with further optimized parameters
...
cv_scores_rf = cross_val_score(best_rf_model, X_umap, y, cv=5, scoring='neg_mean_squared_error', n_jobs=-1)
...
cv_scores_gb = cross_val_score(best_gb_model, X_umap, y, cv=5, scoring='neg_mean_squared_error', n_jobs=-1)
